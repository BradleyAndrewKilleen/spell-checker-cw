...
Configured for coursework. Includes JavaCoreTemplate detailed below. You may review each individual src file and/or run src/sbccunittest/SpellCheckerTester.java to review the unit testing that the final grade is based on. 
